      ...
      <div className="mx-auto grid max-w-7xl gap-10 px-4 md:px-8 lg:grid-cols-2 lg:items-center">
        <div>
          ...
          <p className="mt-5 text-foreground/80">
            Se você está começando agora, não precisa ter vergonha. O mais importante é dar o
            primeiro passo. A SHARK GYM valoriza um ambiente acessível, com orientação e incentivo
            para quem quer melhorar a saúde no próprio ritmo.
          </p>
          <a
